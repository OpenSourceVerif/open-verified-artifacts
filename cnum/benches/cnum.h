...
/* Definitions inside the kernel tree */
...
char *cnum32_fmt(struct cnum32 c);
char *cnum64_fmt(struct cnum64 c);

bool cnum32_contains_new(struct cnum32 cnum, u32 v);
bool cnum64_contains_new(struct cnum64 cnum, u64 v);

struct cnum64 cnum64_normalize(struct cnum64 cnum);
struct cnum64 cnum64_normalize_new(struct cnum64 cnum);

s64 cnum64_smin_new(struct cnum64 cnum);
s64 cnum64_smax_new(struct cnum64 cnum);
